<?php
class ControllerPopupRegister extends Controller {
	public function index() {
		$this->load->language('popup/register');
		...
		$data['action'] = $this->url->link('api/register', '', 'SSL');
		...
		return $this->load->view('default/template/popup/register.tpl', $data);
	}
}
