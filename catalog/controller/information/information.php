...
class ControllerInformationInformation extends Controller {
	public function index() {
		...
		if ($information_info) {
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/information/' . $tpl_path)) {
				$this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/information/' . $tpl_path, $data));
			} else {
				$this->response->setOutput($this->load->view('default/template/information/' . $tpl_path, $data));
			}
		} else {
			$data['breadcrumbs'][] = array(
