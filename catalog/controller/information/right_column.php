<?php
class ControllerInformationRightColumn extends Controller {
    ...
    if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/information/right_column.tpl')) {
			return $this->load->view($this->config->get('config_template') . '/template/information/right_column.tpl', array('products' => $products));
		} else {
			return $this->load->view('default/template/information/right_column.tpl', array('products' => $products));
		}
	}
}
