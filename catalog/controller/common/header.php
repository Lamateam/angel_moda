...
class ControllerCommonHeader extends Controller {
	public function index() {
		...
		$data['text_moscow'] = $this->language->get('text_moscow');
		$data['text_rostow'] = $this->language->get('text_rostow');
		...
		$data['telephone_rostov'] = $this->config->get('config_telephone_rostov');
		...
		foreach ($categories as $category) {
			if ($category['top']) {
				...
				foreach ($children as $child) {
					...
					$sub_children = array();
					foreach ($this->model_catalog_category->getCategories($child['category_id']) as $subchild) {
						$sub_children[] = array(
