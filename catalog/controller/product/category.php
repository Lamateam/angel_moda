...
class ControllerProductCategory extends Controller {
  public function index() {
    ...
    if ($category_info) {
      ...
      if ((int)$category_info['banner_id'] > 0) {
        $this->load->model('design/banner.php');
        $data['banner'] = $this->model_design_banner->getBanner($category_info['banner_id']);
      }
      ...
      if (isset($this->request->get['price_to'])) {
        ...
        $price_to = 9999999999999999999999999999999;
      }
      ...
      foreach ($ps as $product_info) {
        ...
        $p['href'] = $this->url->link('product/product', 'path=' . $this->request->get['path'] . '&product_id=' . $p['product_id'] . $url);
