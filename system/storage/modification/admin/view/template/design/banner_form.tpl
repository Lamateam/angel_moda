            ...
            <thead>
              <tr>
                ...
                <td class="text-right"><?php echo $entry_sort_order; ?></td>
								<td class="text-left"><?php echo $entry_has_end_date; ?></td>
                <td class="text-left"><?php echo $entry_end_date; ?></td>
                <td class="text-right"><?php echo $entry_is_html; ?></td>
                <td></td>
              </tr>
            </thead>
            <tbody>
              ...
              <?php foreach ($banner_images as $banner_image) { ?>
								<tr id="image-row<?php echo $image_row; ?>">
									...
									<td>
										<input type="checkbox" name="banner_image[<?php echo $image_row; ?>][has_end_date]" <?php if($banner_image['has_end_date']) { ?>checked<?php } ?> />
									</td>
									<td class="text-left">
										<input name="banner_image[<?php echo $image_row; ?>][end_date]" value="<?php echo $banner_image['end_date']; ?> />
									</td>
									<td>
										<input type="checkbox" name="banner_image[<?php echo $image_row; ?>][is_html]" <?php if($banner_image['is_html']) { ?>checked<?php } ?> />
									</td>
