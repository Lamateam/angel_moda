     ...
     <div class="hald-sm">
      ...
      <div class="col15-md-5 col-sm-12">
        <ul class="list-unstyled col-xs-6">
          ...
          <li><a href="<?php echo $loyaty; ?>"><?php echo $text_loyaty; ?></a></li>
          <li><a href="<?php echo $wholesale; ?>"><?php echo $text_wholesale; ?></a></li>
        </ul>
        <ul class="list-unstyled col-xs-6">
          <li><a href="<?php echo $choose_size; ?>"><?php echo $text_choose_size; ?></a></li>
          <li><a href="<?php echo $shoptour; ?>"><?php echo $text_shoptour; ?></a></li>
          <li><a href="<?php echo $mailus; ?>"><?php echo $text_mailus; ?></a></li>
