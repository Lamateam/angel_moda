...
class ControllerCatalogCategory extends Controller {
	...
	public function add() {
		...
		$this->load->model('catalog/category');
		$this->load->model('catalog/category_add');

		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			$this->model_catalog_category_add->addCategory($this->request->post);
	...
	public function edit() {
		...
		$this->load->model('catalog/category');
		$this->load->model('catalog/category_edit');

		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			$this->model_catalog_category_edit->editCategory($this->request->get['category_id'], $this->request->post);
	...
	protected function getForm() {
		...
		$data['entry_is_topsub'] = $this->language->get('entry_is_topsub');
		
		$data['entry_banner_id'] = $this->language->get('entry_banner_id');
		...
		if (isset($this->request->post['is_topsub'])) {
			$data['is_topsub'] = $this->request->post['is_topsub'];
		} elseif (!empty($category_info)) {
			$data['is_topsub'] = $category_info['is_topsub'];
		} else {
			$data['is_topsub'] = 0;
		}		
