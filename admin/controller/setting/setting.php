...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$data['entry_telephone_rostov'] = $this->language->get('entry_telephone_rostov');
		...
		$data['entry_vk_link'] = $this->language->get('entry_vk_link');
		$data['entry_facebook_link'] = $this->language->get('entry_facebook_link');
		$data['entry_twitter_link'] = $this->language->get('entry_twitter_link');
		$data['entry_instagram_link'] = $this->language->get('entry_instagram_link');
		
		$data['entry_callback_email'] = $this->language->get('entry_callback_email');
		$data['entry_personal_guide_email'] = $this->language->get('entry_personal_guide_email');
		$data['entry_head_email'] = $this->language->get('entry_head_email');
		...
		if (isset($this->request->post['config_telephone_rostov'])) {
			$data['config_telephone_rostov'] = $this->request->post['config_telephone_rostov'];
		} else {
			$data['config_telephone_rostov'] = $this->config->get('config_telephone_rostov');
		}
		
		if (isset($this->request->post['config_vk_link'])) {
			$data['config_vk_link'] = $this->request->post['config_vk_link'];
		} else {
			$data['config_vk_link'] = $this->config->get('config_vk_link');
		}
		...
		if (isset($this->request->post['config_callback_email'])) {
			...
			$data['config_callback_email'] = $this->config->get('config_callback_email');
		}
		
		if (isset($this->request->post['config_personal_guide_email'])) {
			$data['config_personal_guide_email'] = $this->request->post['config_personal_guide_email'];
		} else {
			$data['config_personal_guide_email'] = $this->config->get('config_personal_guide_email');
		}
		
		if (isset($this->request->post['config_head_email'])) {
			$data['config_head_email'] = $this->request->post['config_head_email'];
		} else {
			$data['config_head_email'] = $this->config->get('config_head_email');
		}
