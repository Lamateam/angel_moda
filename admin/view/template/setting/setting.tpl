        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <li><a href="#tab-local" data-toggle="tab"><?php echo $tab_local; ?></a></li>
						<li><a href="#tab-emails" data-toggle="tab"><?php echo $tab_emails; ?></a></li>
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-store">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-telephone_rostov"><?php echo $entry_telephone_rostov; ?></label>
                  <div class="col-sm-10">
                    <input type="text" name="config_telephone_rostov" value="<?php echo $config_telephone_rostov; ?>" placeholder="<?php echo $entry_telephone_rostov; ?>" id="input-telephone_rostov" class="form-control" />
                  </div>
                </div>
                <div class="form-group">
                ...
                <?php } ?>
						...
						<div class="tab-pane" id="tab-social">
							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-vk_link"><?php echo $entry_vk_link; ?></label>
								<div class="col-sm-10">
									<input type="text" name="config_vk_link" value="<?php echo $config_vk_link; ?>" placeholder="<?php echo $entry_vk_link; ?>" id="input-vk_link" class="form-control" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-facebook_link"><?php echo $entry_facebook_link; ?></label>
								<div class="col-sm-10">
									<input type="text" name="config_facebook_link" value="<?php echo $config_facebook_link; ?>" placeholder="<?php echo $entry_facebook_link; ?>" id="input-facebook_link" class="form-control" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-twitter_link"><?php echo $entry_twitter_link; ?></label>
								<div class="col-sm-10">
									<input type="text" name="config_twitter_link" value="<?php echo $config_twitter_link; ?>" placeholder="<?php echo $entry_twitter_link; ?>" id="input-twitter_link" class="form-control" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-instagram_link"><?php echo $entry_instagram_link; ?></label>
								<div class="col-sm-10">
									<input type="text" name="config_instagram_link" value="<?php echo $config_instagram_link; ?>" placeholder="<?php echo $entry_instagram_link; ?>" id="input-instagram_link" class="form-control" />
								</div>
							</div>							
						</div>
						<div class="tab-pane" id="tab-emails">
							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-callback_email"><?php echo $entry_callback_email; ?></label>
								<div class="col-sm-10">
									<input type="text" name="config_callback_email" value="<?php echo $config_callback_email; ?>" placeholder="<?php echo $entry_callback_email; ?>" id="input-callback_email" class="form-control" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-personal_guide_email"><?php echo $entry_personal_guide_email; ?></label>
								<div class="col-sm-10">
									<input type="text" name="config_personal_guide_email" value="<?php echo $config_personal_guide_email; ?>" placeholder="<?php echo $entry_personal_guide_email; ?>" id="input-personal_guide_email" class="form-control" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-head_email"><?php echo $entry_head_email; ?></label>
								<div class="col-sm-10">
									<input type="text" name="config_head_email" value="<?php echo $config_head_email; ?>" placeholder="<?php echo $entry_head_email; ?>" id="input-head_email" class="form-control" />
								</div>
							</div>	
						</div>
