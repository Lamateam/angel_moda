                  ...
                  <div class="checkbox">
                    <label>
                      ...
                      &nbsp; </label>
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-is_topsub"><?php echo $entry_is_topsub; ?></label>
								<div class="col-sm-10">
									<div class="checkbox">
										<label>
											<?php if ($is_topsub) { ?>
												<input type="checkbox" name="is_topsub" value="1" checked="checked" id="input-is_topsub" />
											<?php } else { ?>
												<input type="checkbox" name="is_topsub" value="1" id="input-is_topsub" />
											<?php } ?>
										&nbsp; </label>
									</div>
								</div>
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-banner-id"><?php echo $entry_banner_id; ?></label>
								<div class="col-sm-10">
									<input type="text" name="banner_id" rows="5" placeholder="<?php echo $entry_banner_id; ?>" id="input-banner_id" class="form-control" value="<?php echo $banner_id; ?>" />
								</div>
							</div>
              <div class="form-group">
